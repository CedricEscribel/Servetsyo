...
$headerData = array('Full Name', 'Contact Number' ,'Kind of Animal', 'Location', 'Date Requested' , 'Set Date ' , 'Status');


// Define custom cell widths for each column
$cellWidths = array(52, 25, 30, 40, 25, 25, 20);

// Code for printing data
$sql = "SELECT  `Name`, `ContNum`, `Animal`, `Coordinates`, `ReqDate`, `SetDate`, `status` from  insemination ";
