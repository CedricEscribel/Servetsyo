...
$headerData = array('Full Name', 'Contact Number' ,'Kind of Animal' ,'Situation', 'Location', 'Date Requested' , 'Status');


// Define custom cell widths for each column
$cellWidths = array(52, 25, 30, 65, 40, 25, 20);

// Code for printing data
$sql = "SELECT  `Name`, `ContactNum`, `animal`, `Details`, `Coordinates`, `ReqDate`, `status` from  rescue ";
